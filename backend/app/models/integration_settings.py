...
class NaumenSyncRun(Base):
    ...
    period_begin: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    period_end: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    rows_by_type: Mapped[str | None] = mapped_column(Text, nullable=True)
    rows_customers: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_projects: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_queues: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_load: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_employees: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_operator_workload: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
    rows_forecast_profile: Mapped[int] = mapped_column(Integer, default=0, nullable=False)
...
class NaumenProject(Base):
    ...
    title: Mapped[str] = mapped_column(String(255), nullable=False)
    partner_uuid: Mapped[str | None] = mapped_column(String(80), nullable=True)
    naumen_customer_uuid: Mapped[str | None] = mapped_column(String(80), nullable=True)
    naumen_project_uuid: Mapped[str | None] = mapped_column(String(80), nullable=True)
    manual_stats_enabled: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
